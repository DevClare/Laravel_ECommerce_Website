              ...
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    ...
                    <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{assets('uploads/products')}}/{{$product->images}}" width="330"
                        height="400" alt="{{$products->name}}" class="pc__img"></a>
                    @endforeach
                  </div>
                  <div class="swiper-slide">
                    @foreach(explode(",",$product->images) as $gimg)
                    <a href="details.html"><img loading="lazy" src="{{asset('uploads/products')}}/{{$gimg}}"
                        width="330" height="400" alt="{{$products->name}}" class="pc__img"></a>
                    @endforeach
                  </div>
                </div>
