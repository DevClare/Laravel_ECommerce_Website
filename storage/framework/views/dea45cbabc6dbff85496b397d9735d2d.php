<ul class="account-nav">
        ...
        <li><form method="POST" action="<?php echo e(route('logout')); ?>" id="logout-form">
                <?php echo csrf_field(); ?>
...
</ul><?php /**PATH C:\LaravelProject\ECommerce_BoostOrder\ecommerce\resources\views/user/account-nav.blade.php ENDPATH**/ ?>